...
Version  : 1.1.100
Release  : 5
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.100.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.100.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.1.100
...
export LANG=C
export SOURCE_DATE_EPOCH=1550609400
mkdir -p clr-build
pushd clr-build
