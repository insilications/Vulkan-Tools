...
Version  : 1.1.112
Release  : 12
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.112/Vulkan-Tools-1.1.112.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.112/Vulkan-Tools-1.1.112.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.1.112
...
export LANG=C
export SOURCE_DATE_EPOCH=1561515724
mkdir -p clr-build
pushd clr-build
