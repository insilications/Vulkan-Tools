...
Version  : 1.1.113
Release  : 13
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.113/Vulkan-Tools-1.1.113.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.113/Vulkan-Tools-1.1.113.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.1.113
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562227039
mkdir -p clr-build
pushd clr-build
