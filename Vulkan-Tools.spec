...
Version  : 1.2.132
Release  : 25
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.2.132/Vulkan-Tools-1.2.132.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.2.132/Vulkan-Tools-1.2.132.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.2.132
cd %{_builddir}/Vulkan-Tools-1.2.132
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581375049
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Tools-1.2.132/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Tools/2b8b815229aa8a61e483fb4ba0588b8b6c491890
pushd clr-build
%make_install
popd
