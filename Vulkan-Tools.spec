...
cp %{_builddir}/Vulkan-Tools-1.1.126/winrt/VulkanRT-License.txt %{buildroot}/usr/share/package-licenses/Vulkan-Tools/d9a9264dc645065662d2c3945277e798882c61d5
pushd clr-build
%make_install
popd
