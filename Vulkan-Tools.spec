...
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.130/Vulkan-Tools-1.1.130.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.1.130
cd %{_builddir}/Vulkan-Tools-1.1.130
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576781682
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Tools-1.1.130/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Tools/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/Vulkan-Tools-1.1.130/windows-runtime-installer/VulkanRT-License.txt %{buildroot}/usr/share/package-licenses/Vulkan-Tools/d9a9264dc645065662d2c3945277e798882c61d5
pushd clr-build
%make_install
popd
...
/usr/share/package-licenses/Vulkan-Tools/d9a9264dc645065662d2c3945277e798882c61d5
