...
Version  : 1.1.108
Release  : 11
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.108/Vulkan-Tools-1.1.108.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.108/Vulkan-Tools-1.1.108.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.1.108
...
export LANG=C
export SOURCE_DATE_EPOCH=1559895583
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
