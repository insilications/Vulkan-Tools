...
Version  : 1.1.123
Release  : 17
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.123/Vulkan-Tools-1.1.123.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.123/Vulkan-Tools-1.1.123.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.1.123
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570926699
mkdir -p clr-build
pushd clr-build
...
cp winrt/VulkanRT-License.txt %{buildroot}/usr/share/package-licenses/Vulkan-Tools/winrt_VulkanRT-License.txt
pushd clr-build
%make_install
popd
...
/usr/share/package-licenses/Vulkan-Tools/winrt_VulkanRT-License.txt
