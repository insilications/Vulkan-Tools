...
Version  : 1.2.135
Release  : 28
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.2.135/Vulkan-Tools-1.2.135.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.2.135/Vulkan-Tools-1.2.135.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.2.135
cd %{_builddir}/Vulkan-Tools-1.2.135
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584719043
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Tools-1.2.135/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Tools/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/Vulkan-Tools-1.2.135/windows-runtime-installer/VulkanRT-License.txt %{buildroot}/usr/share/package-licenses/Vulkan-Tools/884fc355c7334e66b002ff40965b6f9904805d0e
pushd clr-build
%make_install
popd
