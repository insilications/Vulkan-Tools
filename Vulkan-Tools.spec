...
Version  : 1.1.121
Release  : 16
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.121/Vulkan-Tools-1.1.121.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.1.121/Vulkan-Tools-1.1.121.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.1.121
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567779277
mkdir -p clr-build
pushd clr-build
