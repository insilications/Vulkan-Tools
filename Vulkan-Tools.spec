...
cp %{_builddir}/Vulkan-Tools-1.2.137/windows-runtime-installer/VulkanRT-License.txt %{buildroot}/usr/share/package-licenses/Vulkan-Tools/884fc355c7334e66b002ff40965b6f9904805d0e
pushd clr-build
%make_install
popd
